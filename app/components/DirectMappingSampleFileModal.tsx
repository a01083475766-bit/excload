...
export function DirectMappingSampleFileModal({
  ...
  return (
    ...
    >
      <div className="flex w-full max-w-xl flex-col rounded-xl border border-zinc-200 bg-white p-5 shadow-xl dark:border-zinc-800 dark:bg-zinc-900 sm:p-6">
        <div className="mb-4 flex items-start justify-between gap-4">
          <div>
            ...
            <p className="mt-2 text-sm leading-relaxed text-zinc-600 dark:text-zinc-300">
              주문 파일의 헤더를 확인해야 어떤 열을 출력할지 정할 수 있습니다.
              <br />
              자주 쓰는 주문 엑셀 샘플을 선택해 주세요.
            </p>
          </div>
          <button
            type="button"
            ...
            className="rounded-lg p-1 transition-colors hover:bg-zinc-100 disabled:opacity-50 dark:hover:bg-zinc-800"
            aria-label="닫기"
          >
          ...
          {isProcessing ? (
            ...
            <>
              ...
              <button
                ...
                className={`mt-5 rounded-lg px-5 py-2.5 text-sm font-medium text-white ${accentClasses.primaryButton}`}
              >
                주문 샘플 파일 선택
              </button>
            </>
