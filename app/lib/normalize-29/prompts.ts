...
- 01x 휴대전화 → 받는사람전화1
- 시/군/구/로/길/동/읍/면/번지/호/아파트/동/층 등 → 받는사람주소1 (가장 긴 상세 주소)
- 2~4자 한국어 인명 → 받는사람 (상품명·브랜드와 혼동하지 말 것)
- 상품·용량·규격·색상 등 → 상품명 또는 상품옵션
- 상품명 칸에 주소·전화를 넣지 말 것. 받는사람 칸에 상품명 일부만 넣지 말 것.

[한 줄 자유 텍스트]
- "이름 주소 전화 상품" 순서가 아닐 수 있다. 전화·주소 패턴으로 구간을 나눈 뒤 배치한다.

[주문 분리]
- 줄마다 다른 수취인·전화·주소면 orders에 여러 건.
- 애매하면 1건, 필드 오염 금지.
